...
## Project Structure
    ...
    ├── mogul_media_service_28909  # Django project configurations
...
1. Clone this repo and `cd mogul_media_service_28909`
...
2. Clone this repo and `cd mogul_media_service_28909`
